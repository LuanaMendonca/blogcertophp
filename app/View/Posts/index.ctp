...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
	...
	<?php
		echo $this->Html->link(
			...
			array('class' => 'btn btn-primary mt-3 mt-md-0')
		);
	?>
</div>

<?php if (empty($posts)): ?>
	<div class="alert alert-info">Nenhuma postagem cadastrada.</div>
<?php else: ?>
	<div class="row">
				...
				<article class="card post-card shadow-sm">
					<div class="card-body">
						<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-start">
							...
							<span class="badge badge-<?php echo $post['Post']['status'] === 'ativo' ? 'success' : 'secondary'; ?> mb-3 mb-md-0">
							...
							<div class="post-actions">
								<?php
									...
									echo $this->Form->postLink(
										...
										array('class' => 'btn btn-outline-danger btn-sm ml-2'),
